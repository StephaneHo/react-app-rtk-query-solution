...
import { useAddRentalCategoryMutation } from "../store";

export const RentalCategoryModal = forwardRef(function RentalCategoryModal(
  {},
  ref
) {
  ...
  const [addRentalCategory, results] = useAddRentalCategoryMutation();
